...
export abstract class AudioContextBasePipe implements NodeAudioPlayer {
    ...
    onUserInteraction(): void {
        // EN: Resume AudioContext if suspended (created outside a user gesture context)
        // FR: Relancer l'AudioContext s'il est suspendu (créé hors d'un geste utilisateur)
