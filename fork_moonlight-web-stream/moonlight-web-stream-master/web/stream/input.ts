...
export class StreamInput {
    ...
    onGamepadConnect(gamepad: Gamepad) {
        ...
        // EN: Force send initial neutral state to ensure Sunshine creates the virtual gamepad immediately
        // FR: Forcer l'envoi de l'état initial neutre pour s'assurer que Sunshine crée la manette virtuelle immédiatement
        const initialState = extractGamepadState(gamepad, this.config.controllerConfig);
        this.sendController(this.gamepads.length - 1, initialState);
